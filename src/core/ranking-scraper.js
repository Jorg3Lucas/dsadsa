...
/**
 * Fetch ranking data for the configured sync worlds (currently NA42 only).
 * Returns an object: { "553": { "PlayerName": "ClanName", ... } }
 */
export async function fetchMir4RankingData(forceRefresh = false) {
    ...
    const baseUrl = 'https://forum.mir4global.com/rank?ranktype=1&worldgroupid=2&classtype=&searchname=';
